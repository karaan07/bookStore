...
useEffect(() => {
  ...
  return (
    <>
    <div className={`max-w-screen-2x1 container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white top-0 right-0 left-0 ${
    sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 dark:bg-slate-600 dark:text-white transition-all ease-in-out" : ""
}`}>
